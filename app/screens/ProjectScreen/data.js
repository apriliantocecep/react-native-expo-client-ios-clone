export default data = [
    { name: "Published Projects", header: true, button: false, active: false },
    { name: "Emma Stone", header: false, likes: '10.000', image: 'https://m.media-amazon.com/images/M/MV5BMjI4NjM1NDkyN15BMl5BanBnXkFtZTgwODgyNTY1MjE@._V1.._UX214_CR0,0,214,317_AL_.jpg', title: 'Emma Stone', subtitle: 'Emily Jean "Emma" Stone' },

    { name: "TOOLS", header: true, button: false, active: false },
    ...
    { name: "Expo menu gesture", header: true },
    { name: "Shake Device", header: false },
    { name: "Two-finger force touch", header: false, checked: true },
    { name: "Message", header: false, message: 'This gesture will toggle the Expo Menu while inside an experience. The menu allows you to reload or return to home in a published experience, and exposes developer tools in development mode.' },

    { name: "Sign Out", header: false },
];